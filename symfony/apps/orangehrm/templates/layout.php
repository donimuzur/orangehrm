...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php echo $cultureElements[0]; ?>" lang="<?php echo $cultureElements[0]; ?>">
  <head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo theme_path('images/apple-touch-icon.png')?>">
    ...
    <link rel="manifest" href="<?php echo theme_path('images/site.webmanifest')?>">
    <link rel="mask-icon" href="<?php echo theme_path('images/safari-pinned-tab.svg')?>" color="#5bbad5">
