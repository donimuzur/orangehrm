...
/**
 * Actions class for PIM module Employee Contract
 */
class empContractComponent extends sfComponent {
    ...
    public function execute($request) {
        ...
        $this->setForm(new EmployeeContractNewForm(array(), $param, true));
        $this->deleteForm = new EmployeeContractNewDeleteForm(array(), $param, true);
        
        $this->employeeContracts = $this->getEmployeeService()->getEmployeeContractNew($this->empNumber);
    }
